    ...
    for img in imglist:
        ...
        if not arcfile:
            ...
            if arcref:
                ...
                # iraf.longslit.identify(images=arcfile,
                #                        coordli='direc$standard/ident/Lines_HgCdHeNeAr600.dat', nsum=10, fwidth=7,
                #                        order=3, mode='h')

                iraf.longslit.reidentify(referenc=arcref, images=arcfile, interac=_inter,
                ...
                iraf.longslit.identify(images=arcfile, section='column 10',
                                       coordli='direc$standard/ident/Lines_HgCdHeNeAr600.dat', nsum=10, fwidth=7,
                                       order=3, mode='h')
            iraf.longslit.reident(referenc=arcfile, images=arcfile, interac='NO',
            ...
            iraf.specred.transform(input=img, output='test.fits', minput='', fitnames=re.sub('.fits', '', arcfile),
                                   databas='database',
